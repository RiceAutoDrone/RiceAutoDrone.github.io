...
<html lang="en-US"><head>
   <meta charset="utf-8">
    ...
    <!-- Page build 2023-03-24 00:35:46 -0500 -->
    ...
    <script type="application/ld+json">
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "http://localhost:4000/index.md.ll"
      },
      "headline": "Rice Autodrone",
      "image": "https://riceautodrone.github.io/assets/image/drone.jpg",
      "datePublished": "2023-03-24T00:35:46-05:00",
      "dateModified": "2023-03-24T00:35:46-05:00",
      "author": {
        "@type": "Person",
        "name": "Yu Che Lin"
      },
    ...
    <script type="application/ld+json">
{
    ...
    "@type": "WebPage",
    "name": "Rice Autodrone",
    "description": "A MECE Capstone Project - This is the website that provides instruction on how to install all necessary packages/modules."
    }
}
</script><script type="application/ld+json">
{
  ...
  "url" : "http://localhost:4000/"
   ...
   <title>Rice Autodrone | Rice Autodrone</title>
  <link rel="canonical" href="http://localhost:4000/index.md.ll">
    <!-- Atom feed -->
  ...
  <link href="http://localhost:4000/rss.xml" type="application/rss+xml" rel="alternate" title="RSS 2.0 feed Rice Autodrone" >
   ...
   <meta name="description" content="A MECE Capstone Project - This is the website that provides instruction on how to install all necessary packages/modules.">
   <meta name="thumbnail" content="https://riceautodrone.github.io/assets/image/drone.jpg" >
   <meta name="robots" content="index, follow"><meta name="keywords" content="">
    <!-- OpenGraph -->
   <meta property="og:title" content="Rice Autodrone | Rice Autodrone" >
   <meta property="og:site_name" content="Rice Autodrone | A MECE Capstone Project" >
   <meta property="og:url" content="http://localhost:4000/index.md.ll" >
   <meta property="og:type" content="website" >
   <meta property="og:description" content="A MECE Capstone Project - This is the website that provides instruction on how to install all necessary packages/modules." >
   <meta property="og:locale" content="en-US" >
   <meta property="og:image" content="https://riceautodrone.github.io/assets/image/drone.jpg" >
    <!-- Twitter Cards -->
...
<body class="d-flex flex-column h-entry" id="body">
	<a class="u-url d-none" href="http://localhost:4000/index.md.ll">Invisible link to canonical for Microformats</a>
	<div class="navbar-chulapa-fab">
		...
		<nav class="navbar-chulapa-fab-nav" aria-label="primary-navigation">
			<ul class="navbar-nav text-center text-uppercase font-weight-light mt-0 mb-1 py-1">
				...
				</li><li class="nav-item dropdown my-0 py-1"><a class="nav-link dropdown-toggle px-3 py-1 " href="#" id="Raspberry-Pi-Settings" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Raspberry Pi Settings</a>
					<div class="dropdown-menu dropdown-menu-right text-center rounded-0 pr-4" aria-labelledby="Raspberry-Pi-Settings"><a class="dropdown-item nav-link d-block px-3 small " href="http://localhost:4000/raspberrypi_settings">Index </a><a class="dropdown-item nav-link d-block px-3 small " href="http://localhost:4000/raspberrypi_settings/01_access_point">Access Point </a><a class="dropdown-item nav-link d-block px-3 small " href="http://localhost:4000/raspberrypi_settings/02-config">Global Settings </a></div>
	...
	</div>	<header class="d-flex align-items-center hero-chulapa-image" style="background-image: linear-gradient(rgba(0, 0, 0, 0.15), rgba(0, 0, 0, 0.7)), url('https://riceautodrone.github.io/assets/image/drone.jpg')"><div class="container-lg py-4">
   <h1 class="p-name">Rice Autodrone</h1><hr class="my-3">
   <p class="chulapa-subtitle p-summary">A MECE Capstone Project</p>
 </div>
</header>
